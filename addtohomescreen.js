...
(function (window, document) {
    ...
    */
    ...
    ath.intl = {
        ...
        zh_cn: {
            ios: '如要把应用程序加至主屏幕,请使用Safari打开并点击%icon, 然后<strong>添加到主屏幕</strong>',
            android: '要将此web应用程序添加到主屏幕，请打开浏览器选项菜单并点击<strong>添加到主屏幕</strong>。<small>按菜单硬件按钮（如果您的设备有）或轻触右上角的菜单图标%icon，可以访问菜单。</small>'
            // android: 'To add this web app to the home screen open the browser option menu and tap on <strong>Add to homescreen</strong>. <small>The menu can be accessed by pressing the menu hardware button if your device has one, or by tapping the top right menu icon %icon.</small>'
        },
        ...
        show: function (force) {
            ...
            if ( !this.applicationIcon ) {
                if ( ath.OS == 'ios' ) {
                    ...
                    this.applicationIcon = document.querySelector('head link[rel^="shortcut icon"][sizes="144x144"],head link[rel^=apple-touch-icon]');
                }
            }
            ...
            if ( this.options.icon && this.applicationIcon ) {
                ...
                console.log(this.applicationIcon.href);
                this.img.src = this.applicationIcon.href;
                this.element.appendChild(this.img);
    
                // this.element.className += ' ath-icon';
       //          this.a = document.createElement('a');
       //          this.a.style.width="252px";
       //          this.a.style.height="100px";
       //          this.a.style.display="block";
       //          this.a.className = 'ath-enter';
                // this.img = document.createElement('img');
                // this.img.className = 'ath-application-icon';
                // this.img.addEventListener('load', this, false);
                // this.img.addEventListener('error', this, false);
